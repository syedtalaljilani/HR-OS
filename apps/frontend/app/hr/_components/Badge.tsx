...
const PALETTE: Record<string, string> = {
  ...
  OPEN: "bg-violet-50 text-violet-700 ring-violet-300",
  ...
  SHORTLISTED: "bg-violet-50 text-violet-700 ring-violet-300",
  ...
  ACTIVE: "bg-violet-50 text-violet-700 ring-violet-300",
  CONTACTED: "bg-blue-50 text-blue-700 ring-blue-300",
  INTERESTED: "bg-violet-50 text-violet-700 ring-violet-300",
