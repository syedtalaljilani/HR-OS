    ...
    <>
      <header className="border-b border-violet-200 bg-white">
        <div className="mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2 text-lg font-bold text-zinc-900">
            <span className="flex h-8 w-8 items-center justify-center bg-violet-600 text-white">
      ...
      <footer className="bg-violet-950 text-violet-200">
        <div className="mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-8 text-sm">
          ...
          <Link href="/login" className="border border-violet-600 bg-violet-600 px-4 py-2 text-xs font-semibold text-white hover:bg-violet-700">
            HR login
          </Link>
        </div>
      </footer>
